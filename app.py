...
st.set_page_config(
    page_title="Dashboard Meteorológico - São José dos Campos",
    page_icon="🌤️",
    layout="wide",
...
# Título principal
st.title("🌤️ Dashboard Meteorológico - São José dos Campos-SP")
st.markdown("---")
...
def load_data():
    ...
    file_path = "data/inmet_data_sao_jose_dos_campos_combined.csv"
...
if df is not None:
    ...
    if st.checkbox("Mostrar dados brutos"):
        ...
        st.download_button(
            ...
            data=csv,
            file_name=f"dados_meteorologicos_sjc_{datetime.now().strftime('%Y%m%d')}.csv",
            mime="text/csv"
        )
