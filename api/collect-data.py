...
def handler(request):
    ...
    try:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            # Procurar arquivos CSV de São José dos Campos
            csv_files = glob.glob(os.path.join(temp_dir, "*SAO JOSE DOS CAMPOS*.CSV"))
            ...
            for csv_file in csv_files:
                try:
                    ...
                    # Filtrar apenas São José dos Campos
                    df_sjc = df[df.get('NOME_DA_ESTACAO', '').str.upper() == 'SAO JOSE DOS CAMPOS']
