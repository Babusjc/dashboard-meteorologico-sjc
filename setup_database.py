...
def setup_database(database_url):
    ...
    try:
        ...
        CREATE TABLE IF NOT EXISTS dados_meteorologicos (
            ...
            estacao VARCHAR(10) DEFAULT 'A207',
            nome_estacao VARCHAR(100) DEFAULT 'SAO JOSE DOS CAMPOS',
            uf VARCHAR(2) DEFAULT 'SP',
            regiao VARCHAR(2) DEFAULT 'SE',
            latitude DECIMAL(10, 6) DEFAULT -23.2237,
            longitude DECIMAL(10, 6) DEFAULT -45.9009,
        ...
        if count == 0:
            ...
            while current_date <= end_date:
                # Simular dados meteorológicos realistas para São José dos Campos
