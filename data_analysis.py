...
def analyze_and_predict_weather(file_path="data/inmet_data_sao_jose_dos_campos_combined.csv"):
    ...
    plt.title("Temperatura Média ao Longo do Tempo em São José dos Campos")
    plt.xlabel("Data")
    plt.ylabel("Temperatura Média (°C)")
    plt.grid(True)
    plt.savefig("data/temperatura_media_sjc.png")
    plt.close()
    ...
    plt.grid(True)
    plt.savefig("data/previsao_vs_real_sjc.png")
    plt.close()

    print("\n--- Visualizations Saved ---")
    print("temperatura_media_sjc.png")
    print("previsao_vs_real_sjc.png")
